...
public class MemberView {
	private MemberController_prev controller = new MemberController_prev(); ;
	...
	public void startMemberProgram() {
		...
		finish: while (true) {
			...
			case 2:
				...
				int index = controller.findIndexByName(name);
	...
	public Member inputMember() {
		...
		String memeberEmail = sc.next();
		System.out.print("전화번호 : ");
		String memberPhone = sc.next();
		Member member = new Member(memberId, memberPw, memberName, memeberEmail, memberPhone);
		return member;
	...
	public Member modifyMember(Member member) {
		...
		System.out.print("전화번호 : ");
		String memberPhone = sc.next();
//		Member member = new Member(memberPw,memeberEmail,memberPhone);
